...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_SILVER_WEAK = span_warning("Silver is the greatest threat to my existence. I cannot touch it at all. Blows from silver weapons will set me alight, inhibiting any regeneration, and - if blessed - can outright destroy my body on critical blows."),
	...
	TRAIT_DARKBLOOD = span_warning("As a radical Otavan cure against the ailments of nitecreechers, my blood was tempered by crude cures and profane remedies. It worked, but now it runs foul and bitter, repulsive to those who would feed upon it, yet grants me an odd resistance to infection and disease."),
