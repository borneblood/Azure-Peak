/datum/antagonist/unbound_spellblade
	...
	confess_lines = list(
		"I AM AN UNBOUND SPELLBLADE!",
		"I AM A SKELETON WITH A SPELLBLADE!",
		"MY BONES REMEMBER THE ARCYNE!",
		"THE ARCYNE FLOWS THROUGH MY SKELETON!",
		"I AM A SKELETON WITHOUT A MASTER!",
		"MY SKELETON WIELDS SPELL AND STEEL!",
