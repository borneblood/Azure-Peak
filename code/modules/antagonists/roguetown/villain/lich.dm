...
/datum/antagonist/lich
	...
	confess_lines = list(
		...
		"I NO LONGER BELONG TO LIFE OR DEATH!",
		"I HAVE OUTLIVED MY MORTAL FORM!",
		"DEATH NO LONGER APPLIES TO ME!",
		"I EXIST BEYOND THE LIMITS OF LIVING FLESH!",
		"I HAVE MADE MORTALITY OBSOLETE!"
	)
	rogue_enabled = TRUE
