/datum/antagonist/unbound_death_knight
	...
	confess_lines = list(
		"I AM AN UNBOUND DEATH KNIGHT!",
		"NO NECROMANCER HOLDS MY BONES!",
		"I AM A SKELETON, YET I ACT OF MY OWN WILL!",
		"MY BONES ARE FREE FROM ANOTHER'S CONTROL!",
		"I WALK AS A SKELETON WITHOUT A MASTER!",
		"I AM DEAD, BUT MY WILL IS LASTING.",
		"I AM A FLESHLESS REVENANT!",
		"I AM CLEARLY DEAD, YOU FOOL!"
	)
	rogue_enabled = TRUE
